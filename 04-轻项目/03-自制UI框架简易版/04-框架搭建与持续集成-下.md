...
4. 上传，那么怎么上传呢？
   ...
   2. 注册好之后，会给你发一份邮件，需要注意的是，你一定要打开那份发过来的邮件，以确定这个邮箱是你的！不然，凭空写一个人家的邮箱地址的话，显然是GG的行为。总之，把点击那份验证邮箱的url，你是不能上传的！
...
虽然已经上传成功了，但是我们无法确保我们的代码对人别人来说是否能用
...
1. 猜测别人是如何用我们自己的包的。
   ...
   我们知道这个包是一个基于vue的轮子，那么用我们这个包的人肯定是使用vue的用户啦！
